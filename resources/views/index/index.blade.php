    ...
    @section('content')
     ...
     <ul class="reg-login-click">
      <li><a href="{{url('/shop/login')}}">登录</a></li>
      <li><a href="{{url('/shop/register')}}" class="rlbg">注册</a></li>
      <div class="clearfix"></div>
     </ul><!--reg-login-click/-->
     ...
     <div class="index-pro1">
      ...
      <div class="index-pro1-list">
       <dl>
        <dt><a href="{{url('/shop/protect/'.$v->goods_id)}}"><img src="{{env('UPLOADS_URL')}}{{$v->goods_img}}"/></a></dt>
        <dd class="ip-text"><a href="{{url('/shop/protect/'.$v->goods_id)}}">{{$v->goods_name}}</a><span>已售：488</span></dd>
